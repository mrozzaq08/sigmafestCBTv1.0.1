...
echo form_open_multipart('guru/query_update',array('class'=>'form-horizontal','id'=>'form-confirm-changes')); ?>
    <div class="row">
        ...
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <div class="col-sm-9">
                        <input required value="<?php echo $record->nip;?>" name="nip" data-rel="tooltip" class="col-xs-10" type="text" title="Ubah nomor induk pegawai (NIP)" data-placement="bottom" />
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-3 control-label no-padding-right">Nama lengkap</label>
                <div class="col-sm-9">
                    <input required value="<?php echo $record->nama_lengkap;?>" name="nama" data-rel="tooltip" class="col-xs-10" type="text" title="Ubah nama lengkap pengajar" data-placement="bottom" />
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-3 control-label no-padding-right">Alamat lengkap</label>
                <div class="col-sm-9">
                    <textarea data-rel="tooltip" name="alamat" class="col-xs-10" title="Ubah alamat lengkap pengajar" data-placement="bottom"><?php echo $record->alamat;?></textarea>
                </div>
            </div> 
            <div class="form-group">
                <label class="col-sm-3 control-label no-padding-right">No. Telepon</label>
                <div class="col-sm-9">
                    <input required value="<?php echo $record->no_telp;?>" name="no_telp" data-rel="tooltip" class="col-xs-5" type="number" title="No. telepeon atau mobile" data-placement="bottom" />
                </div>
            </div> 
            <div class="form-group">
        ...
        <div class="col-sm-6">
            <div class="form-group">
                    ...
                    <div class="col-sm-9">
                            <input required value="<?php echo $record->username_login;?>" name="uname" data-rel="tooltip" class="col-xs-10" type="text" title="Ubah username untuk autentikasi (login)" data-placement="bottom" />
                    </div>
            </div>
            <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right">Password</label>
                    <div class="col-sm-9">
                            <input name="fpass" data-rel="tooltip" class="col-xs-10" type="password" title="Ubah password atau kata sandi untuk autentikasi (login)" data-placement="bottom" />
                    </div>
                    <br>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                        <input value="<?php echo $record->email;?>" name="email" data-rel="tooltip" class="col-xs-10 email" type="text" title="Ubah alamat e-mail" data-placement="bottom" />
                </div>
            </div>
            <div class="form-group">
