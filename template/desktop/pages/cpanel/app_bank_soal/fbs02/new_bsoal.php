    ...
    <input type="hidden" name="bs_type" value="bs-2">
		...
		<div class="col-sm-9">
                    <select data-rel="tooltip" onchange="get_bsoal_type(this.value);" data-placeholder="Pilih guru atau pengajar" class="col-xs-8">
                            ...
                            <option selected value="bsoal-type-2">Multiple Pilihan - Jawaban Ganda</option>
        ...
        <div class="form-group">
            <div class="col-sm-8 col-sm-offset-2">
                <h4><i class="fa fa-pencil-square"></i>&nbsp;&nbsp;
                    ...
                    <small class="pull-right">
                        <label>
                            <input type="checkbox" class="ace" name="checkbox[]" value="0">
                            <span class="lbl">&nbsp; Pilih sebagai jawaban yang benar</span>
                        </label>
                    </small>
                </h4>
                <div class="space-6"></div>
                <textarea name="option[]" id="editor-1" data-rel="tooltip" class="col-xs-12" title="Kode atau ID sudah otomatis" data-placement="bottom"></textarea>
            </div>
	</div>
        ...
        <div class="form-group">
            <div class="col-sm-8 col-sm-offset-2">
                <h4><i class="fa fa-pencil-square"></i>&nbsp;&nbsp;
                    ...
                    <small class="pull-right">
                        <label>
                            <input type="checkbox" class="ace" name="checkbox[]" value="1">
                            <span class="lbl">&nbsp; Pilih sebagai jawaban yang benar</span>
                        </label>
                    </small>
                </h4>
                <div class="space-6"></div>
                <textarea name="option[]" id="editor-2" data-rel="tooltip" class="col-xs-12" title="Kode atau ID sudah otomatis" data-placement="bottom"></textarea>
            </div>
	</div>
        <div class="form-group">
            <div class="col-sm-8 col-sm-offset-2">
                <h4><i class="fa fa-pencil-square"></i>&nbsp;&nbsp;
                    ...
                    <small class="pull-right">
                        <label>
                            <input type="checkbox" class="ace" name="checkbox[]" value="2">
                            <span class="lbl">&nbsp; Pilih sebagai jawaban yang benar</span>
                        </label>
                    </small>
                </h4>
                <div class="space-6"></div>
                <textarea name="option[]" id="editor-3" data-rel="tooltip" class="col-xs-12" title="Kode atau ID sudah otomatis" data-placement="bottom"></textarea>
            </div>
	</div>
        <div class="form-group">
            <div class="col-sm-8 col-sm-offset-2">
                <h4><i class="fa fa-pencil-square"></i>&nbsp;&nbsp;
                    ...
                    <small class="pull-right">
                        <label>
                            <input type="checkbox" class="ace" name="checkbox[]" value="3">
                            <span class="lbl">&nbsp; Pilih sebagai jawaban yang benar</span>
                        </label>
                    </small>
                </h4>
                <div class="space-6"></div>
                <textarea name="option[]" id="editor-4" data-rel="tooltip" class="col-xs-12" title="Kode atau ID sudah otomatis" data-placement="bottom"></textarea>
            </div>
	</div>
        ...
        <div class="form-group">
            <div class="col-sm-8 col-sm-offset-2">
                <h4><i class="fa fa-pencil-square"></i>&nbsp;&nbsp;
                    ...
                    <small class="pull-right">
                        <label>
                            <input type="checkbox" class="ace" name="checkbox[]" value="4">
                            <span class="lbl">&nbsp; Pilih sebagai jawaban yang benar</span>
                        </label>
                    </small>
                </h4>
                <div class="space-6"></div>
                <textarea name="option[]" id="editor-5" data-rel="tooltip" class="col-xs-12" title="Kode atau ID sudah otomatis" data-placement="bottom"></textarea>
            </div>
	</div>
