...
?>
    ...
    <input type="hidden" name="bs_type" value="bs-1">
        ...
        <div class="form-group">
            <div class="col-sm-8 col-sm-offset-2">
                <h4><i class="fa fa-pencil-square"></i>&nbsp;&nbsp;
                    ...
                    <small class="pull-right">
                        <label>
                            <input type="radio" class="ace" name="skor" value="0">
                            <span class="lbl">&nbsp; Pilih sebagai jawaban yang benar</span>
                        </label>
                    </small>
                </h4>
                <div class="space-6"></div>
                <textarea name="option[]" id="editor-1" name="id" data-rel="tooltip" class="col-xs-12" title="Kode atau ID sudah otomatis" data-placement="bottom"></textarea>
            </div>
	</div>
        ...
        <div class="form-group">
            <div class="col-sm-8 col-sm-offset-2">
                <h4><i class="fa fa-pencil-square"></i>&nbsp;&nbsp;
                    ...
                    <small class="pull-right">
                        <label>
                            <input type="radio" class="ace" name="skor" value="1">
                            <span class="lbl">&nbsp; Pilih sebagai jawaban yang benar</span>
                        </label>
                    </small>
                </h4>
                <div class="space-6"></div>
                <textarea name="option[]" id="editor-2" name="id" data-rel="tooltip" class="col-xs-12" title="Kode atau ID sudah otomatis" data-placement="bottom"></textarea>
            </div>
	</div>
        <div class="form-group">
            <div class="col-sm-8 col-sm-offset-2">
                <h4><i class="fa fa-pencil-square"></i>&nbsp;&nbsp;
                    ...
                    <small class="pull-right">
                        <label>
                            <input type="radio" class="ace" name="skor" value="2">
                            <span class="lbl">&nbsp; Pilih sebagai jawaban yang benar</span>
                        </label>
                    </small>
                </h4>
                <div class="space-6"></div>
                <textarea name="option[]" id="editor-3" name="id" data-rel="tooltip" class="col-xs-12" title="Kode atau ID sudah otomatis" data-placement="bottom"></textarea>
            </div>
	</div>
        <div class="form-group">
            <div class="col-sm-8 col-sm-offset-2">
                <h4><i class="fa fa-pencil-square"></i>&nbsp;&nbsp;
                    ...
                    <small class="pull-right">
                        <label>
                            <input type="radio" class="ace" name="skor" value="3">
                            <span class="lbl">&nbsp; Pilih sebagai jawaban yang benar</span>
                        </label>
                    </small>
                </h4>
                <div class="space-6"></div>
                <textarea name="option[]" id="editor-4" name="id" data-rel="tooltip" class="col-xs-12" title="Kode atau ID sudah otomatis" data-placement="bottom"></textarea>
            </div>
	</div>
        <div class="form-group">
            <div class="col-sm-8 col-sm-offset-2">
                <h4><i class="fa fa-pencil-square"></i>&nbsp;&nbsp;
                    ...
                    <small class="pull-right">
                        <label>
                            <input type="radio" class="ace" name="skor" value="4">
                            <span class="lbl">&nbsp; Pilih sebagai jawaban yang benar</span>
                        </label>
                    </small>
                </h4>
                <div class="space-6"></div>
                <textarea name="option[]" id="editor-5" name="id" data-rel="tooltip" class="col-xs-12" title="Kode atau ID sudah otomatis" data-placement="bottom"></textarea>
            </div>
	</div>
