...
echo form_open('bsoal/query_create',array('class'=>'form-horizontal','id'=>'form-confirm-changes'));?>
    ...
    <input type="hidden" name="bs_type" value="bs-3">
		...
		<div class="col-sm-9">
                    <select data-rel="tooltip" onchange="get_bsoal_type(this.value);" data-placeholder="Pilih guru atau pengajar" class="col-xs-8">
                            ...
                            <option selected value="bsoal-type-3">Melengkapi Kalimat Rumpang</option>
		...
		<div class="col-sm-8 col-sm-offset-2">
                        ...
                        <p><small>Tuliskan pertanyaan atau kalimat dengan jelas ataupun lengkap.<br>
			...
			<textarea id="epertanyaan" name="pertanyaan" data-rel="tooltip" class="col-xs-12 cke-pertanyaan" title="Kode atau ID sudah otomatis" data-placement="bottom"></textarea>
                        <br><p><small>Gunakan 5 (lima)&nbsp;underskor(_)&nbsp;untuk mengkonversi atau mengubah menjadi kolom isian pada soal.<br>
                            Anda dapat membuat kolom isian lebih dari 1 (satu)<br>
                            Contoh 1: 5 + 4 adalah _____<br>
                            Contoh 2: 5 + _____ = 9<br>
                            1. Contoh 1 pada soal akan menjadi 5 + 5 adalah <input type="text" size="3"><br><br>
                            2. Contoh 2 pada soal akan menjadi 5 + <input type="text" size="3"> = 9<br>
                            </small></p>
                </div>
	</div>
        <div class="form-group">
		...
		<label class="col-sm-3 control-label no-padding-right">Tulis Jawaban Benar</label>
                <div class="col-sm-9">
                        <input required name="option[]" data-rel="tooltip" class="col-xs-8" type="text" title="Masukan nama mata pelajaran" data-placement="bottom" /><br>
                        <br><p>
                    <small>Peserta ujian harus mencocokan dengan jawaban ini.</small></p>
                         <small>Berikan simbol koma&nbsp;(,)&nbsp;pada kolom jawaban sebagai pemisah untuk jawaban selanjutnya (jika lebih dari satu kolom isian).<br>
                        Contoh: jawban 1,jawban 2,jawaban 3<br>
                        Tidak case sensitive</small>
                </div>
