...
echo form_open('bsoal/query_update',array('class'=>'form-horizontal','id'=>'form-confirm-changes'));?>
    ...
    <input type="hidden" name="bs_type" value="bs-5">
		...
		<?php 
                ...
                foreach($query->result() as $data_pil) {
		?>

        <div class="form-group">

		<label class="col-sm-3 control-label no-padding-right">Pilihan <?php echo $no_pil;?>)</label>
                <div class="col-sm-9">
                        ...
                        <br><p>
                    <small>Contoh: Pilihan <?php echo $no_pil;?>=Jawaban <?php echo $no_pil;?></small></p>
