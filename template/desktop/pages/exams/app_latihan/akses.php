...
/**
    ...
    * @twitter    : @IBeESNay
 */
echo form_open('exams/submit_latihan/'.$id_ujian,array('id'=>'e-form'));
                        ...
                        <table border="0" width="100%">
                            ...
                            foreach($assigned_soal[1] as $keys => $pilihan){
                                if($pilihan['id_soal'] == $pertanyaan['id_soal']){
                                    ...
                                    echo "<input id='pilihan-$key-$count_pil' class='ace' type='radio' name='answers_$key' value='$value_pilihan' $checked>";
                                    echo '<span class="lbl">&nbsp;&nbsp;';
                        ...
                        <table border="0" width="100%">
                            ...
                            <tr>
                                <td align="left"> 
                                    ...
                                    <?php } else { ?>
                                    <a data-target="#bottom-menu" class="aside-trigger btn btn-sm btn-primary" style="cursor:pointer;" 
                        ...
                        <table border="0" width="100%">
                            ...
                            foreach($assigned_soal[1] as $keys => $pilihan){
                                if($pilihan['id_soal'] == $pertanyaan['id_soal']){
                                    if ($hasil->type == 'L') 
                                    {
                                        $value_pilihan_1 =  $pilihan['id_pilihan'];
                                    }
                                    else
                                    {
                                        $value_pilihan_1 = $pilihan['id_pilihan']."-".$pilihan['skor'];
                                    ...
                                    echo "<tr>";
                                    echo "<td><td width='2%'>$alfabet[$count_pil].</td><td><div class='radio'><label><input class='ace' id='pilihan-$key-$count_pil' type='checkbox' name='answers_".$key."[]' value='$value_pilihan_1' $checked>";
                                    echo '<span class="lbl">&nbsp;&nbsp;';
                                    echo html_entity_decode($pilihan['pilihan']);
                                    echo "</span></label></div></td>";
                                    echo "</tr>";
                    ...
                    <div class="hr hr8 hr-double hr-dotted"></div>
                        ...
                        foreach($assigned_soal[1] as $keys => $pilihan){
                            if($pilihan['id_soal'] == $pertanyaan['id_soal']){
                                ...
                                <input type="hidden" name="soal_benar_<?php echo $key;?>[]" value="<?php echo $pilihan_benar;?>" id="">
                                <?php
                        ...
                        ?>
                        <input type="hidden" name="soal_pilihan_<?php echo $key;?>[]" value="<?php echo $id_pilihan[$keym];?>" id="">
                        <input type="hidden" name="soal_pilihan_val_<?php echo $key;?>[]" value="<?php echo $val;?>" id="">
